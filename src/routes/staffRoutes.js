...
router.get('/staff', authRequired, adminOnly, staffController.getAllStaff )
// create new staff members
router.post('/staff', authRequired, adminOnly, staffController.createStaff);
// update staff members
router.patch('/staff/:id', authRequired, adminOnly, staffController.updateStaff);
// view your profile
